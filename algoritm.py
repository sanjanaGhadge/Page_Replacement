...
def theory():
    # Provide the full path to your Python interpreter
    python_path = r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Python 3.11"

    # Path to the Python script
    file_path = r"C:\Users\Admin\OneDrive\Desktop\COS pbl\Theory.py"
...
def cell(element):
    ...
    global row
    global col
    # Remove previously displayed label if exists
